package com.ken.utils.mybatis.generator.plugins;
 ...
 * @date 2020/1/2 17:22
 */
public class RemarkPlugin extends PluginAdapter {
    @Override
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        String dataStr = "生成时间: " + (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date()) + " ### -->";
        topLevelClass.addJavaDocLine(" * created : " + dataStr);
        topLevelClass.addJavaDocLine(" */");
        return true;
    }
    ...
    private void comment(JavaElement element, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
        ...
        element.addJavaDocLine(" * tableAlias:  " + introspectedColumn.getTableAlias());
        ...
        element.addJavaDocLine(" * getDefaultValue:  " + introspectedColumn.getDefaultValue());
        element.addJavaDocLine(" */");
    }
